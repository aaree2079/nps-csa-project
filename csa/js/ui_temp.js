...
function skipPrint(){
	const html = `<ul class="skip-nav">
		...
		<li><a href="#allmenu">전체메뉴 바로가기</a></li>
...
function headerPrint(){
	...
	<div class="header-top-inner">
		<div class="header-logo">
			<h1 class="logo"><a href="#none">중앙노후준비지원센터,NPS 국민연금 노후준비서비스</a></h1>
		</div>
		...
		<div class="header-util">
			...
			<div class="header-searchbox">
				<div class="search-form">
					<fieldset class="form">
						<legend>통합검색</legend>
						<input type="text" title="검색어 입력" placeholder="검색어를 입력하세요." class="search-input">
			...
			<!--// 231124 검색위치이동 -->
			<button class="header-allmenu-btn">전체메뉴 열기</button>
					...
					<div class="allmenu-top">
						<div class="jumplistbox related-site">
							...
							<div class="search-form">
								<fieldset class="form">
									<legend>통합검색</legend>
									<input type="text" title="검색어 입력" placeholder="찾으시는 검색어를 입력하세요." class="search-input">
									<button type="button" class="search-btn">검색</button>
								</fieldset>
							</div>
							<!-- // 231124 검색위치이동 -->
